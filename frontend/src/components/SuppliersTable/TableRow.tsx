...
const TableRow = ({ item, width, editSupplierHandler }: TableProps) => {
  ...
  return (
    <S.Container>
      ...
      <TableDropdown isOpen={isDropdownOpen} hiddenCols={hiddenCols} item={item} editSupplierHandler={editSupplierHandler} />
    </S.Container>
  );
};
